...
for fanout in "${fanouts[@]}"; do
  ...
  for batch_size in "${batch_sizes[@]}"; do
    ...
    output=$(python3 node_classification.py --dataset=$1 --batch_size=$batch_size --fan_out=$fanout,$fanout,$fanout --epoch=$2 --spmm=respmm --sampling=metis --sampler full)
    ...
    filename="training_time/$1/$1_F${fanout}_B${batch_size}_${epoch}_Sampling_respmm_full_sampler.txt"
