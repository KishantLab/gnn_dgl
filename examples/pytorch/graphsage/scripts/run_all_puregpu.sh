...
# ./run_script_respmm_puregpu.sh reddit 10
# ./run_script_gespmm_puregpu.sh reddit 10
# ./run_script_base_puregpu.sh reddit 10

./run_script_respmm_puregpu.sh ogbn-products 10
./run_script_gespmm_puregpu.sh ogbn-products 10
./run_script_base_puregpu.sh ogbn-products 10

./run_script_respmm_puregpu.sh igb-small 10
./run_script_gespmm_puregpu.sh igb-small 10
./run_script_base_puregpu.sh igb-small 10

./run_script_respmm_puregpu.sh amazon-products 10
./run_script_gespmm_puregpu.sh amazon-products 10
./run_script_base_puregpu.sh amazon-products 10

./run_script_respmm_puregpu.sh wiki5M 10
./run_script_gespmm_puregpu.sh wiki5M 10
./run_script_base_puregpu.sh wiki5M 10
